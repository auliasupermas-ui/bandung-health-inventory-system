...
```bash
git remote add encore encore://bandung-health-inventory-system-8hg2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/bandung-health-inventory-system-8hg2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/bandung-health-inventory-system-8hg2/settings/integrations/github)
